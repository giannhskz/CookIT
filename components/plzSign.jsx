...
export const PlzSign = () => {
  return (
    <div className="bg-[url('../public/food.png')] h-screen  bg-cover ">
      <div className=" bg-black bg-opacity-50 h-screen bg-cover">
        <div className="flex justify-center mx-4">
          <div className="w-1/2 md:w-full xl:w-1/2 px-4 ">
            <div className=" h-full backdrop-blur-md bg-white/50 border-2 border-[#fce4e4] rounded-lg overflow-hidden mt-10">
              <div className="p-8 text-center">
                ...
                <p className="text-base text-body-color leading-relaxed mb-7">
                  ...
                  <br />
                  After Loging in you may create your won Pantry and access
                  thousands of recipes, based on your desired incredients.
                </p>
